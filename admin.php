...
<body>
    ...
    <section class="login-section">
        <form method="post" id="login-form-admin" class="login-form" action="validate.php">
            <div class="login-for">
                <h1 class="modern-border">ADMIN</h1>
            </div>
            <div class="login-inputs">
                <input type="text" placeholder="Email" name="email" class="classic-border input-highlight">
                <input type="password" placeholder="Password" name="password" class="classic-border input-highlight">
            </div>      
            <div class="login-buttons">
                <input type="submit" value="log in" class="modern-border button-design2" name="login-admin">
            </div>      
        </form>
